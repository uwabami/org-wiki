...
Example: If the current page is 'Smalltalk programming'
and the user select the file 'extendingClasses-number1.gst'
it will open the file below with Emacs.
...
Browse Pages
  ...
  [hj]  - Switch between org-wiki buffers        - M-x org-wiki-switch-root
